...
<!-- NAV BAR --> <!-- NAV BAR -->
        ...
        <div id="sign">
          <form class="form-signin" role="form">
            ...
            <input type="email" class="form-control" placeholder="您的邮箱" required autofocus>
          ...
          <form class="form-signin" role="form">
            ...
            <input type="email" class="form-control" placeholder="您的邮箱" required autofocus>
            <input type="email" class="form-control" placeholder="您的手机号码" required>
            <input type="password" class="form-control" placeholder="设置您的密码" required>
            <div class="row col-md-6">
